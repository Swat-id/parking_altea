        ...
        try:
            ...
            for config in configs:
                ...
                result.append({
                    ...
                    'status': parking.status,
                    'auto_correction_enabled': config.auto_correction_enabled,
                    'correction_hour': getattr(config, 'correction_hour', 6),
                    'correction_minute': getattr(config, 'correction_minute', 0),
                    'sample_count': config.sample_count,
                    'confidence_level': config.confidence_level,
                    'avg_hourly_drift': config.avg_hourly_drift,
                    'avg_daily_drift': getattr(config, 'avg_daily_drift', 0),
                    'suggested_correction': getattr(config, 'suggested_correction', 0),
