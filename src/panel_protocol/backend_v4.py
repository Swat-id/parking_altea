#!/usr/bin/env python3
"""
Módulo de integración backend para paneles LED (v4)
Funciones optimizadas para uso en aplicaciones backend
Compatible con Panel Tipo 4 (16 ventanas)
"""
...
class PanelBackendV4:
    """
    Clase para integración de paneles LED en aplicaciones backend (v4)
    ...
    def __init__(
        ...
        """
        self.panel = PanelProtocolV4(ip_address, port)
    ...
    def send_to_window(
        ...
        Args:
            window_number: Número de ventana (0-15 para Tipo 4)
            text: Texto a enviar
            ...
            try:
                ...
                if response:
                    ...
                    if len(response) >= 13 and response[12] == 0x00:
                        ...
                        error_msg = f"Panel returned error code: {response[12]:02x}" if len(response) > 12 else "Invalid response"
    ...
    def send_same_to_all_windows(
        ...
        Args:
            text: Texto a enviar
            windows: Lista de números de ventana (0-15)
            color: Color del texto
            font_size: Tamaño de fuente
            alignment: Alineación
            effect: Efecto de visualización
    ...
    def clear_window(
        ...
        Args:
            window_number: Número de ventana a limpiar (0-15)
    ...
    def clear_all_windows(
        ...
        Args:
            windows: Lista de ventanas a limpiar (0-15)
...
def quick_send_v4(
    ...
    """
    Función rápida para enviar texto (interfaz simplificada) - v4
    
    Args:
        ip: IP del panel
        window: Número de ventana (0-15)
        text: Texto a enviar
...
def quick_send_all_v4(
    ...
    """
    Función rápida para enviar a múltiples ventanas - v4
    
    Args:
        ip: IP del panel
        windows: Lista de ventanas (0-15)
        text: Texto a enviar
