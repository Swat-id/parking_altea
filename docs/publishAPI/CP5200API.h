...
//=====================================
//20160423
CP5200API int		CALLING_CONV CP5200_MakeWritePrivateCodeData(HOBJECT hObj, BYTE* pBuffer, int nBufSize, const BYTE* pCodeData, int nCodeLen);
CP5200API int		CALLING_CONV CP5200_ParseWritePrivateCodeRet(HOBJECT hObj, const BYTE* pBuffer, int nLength);

CP5200API int		CALLING_CONV CP5200_MakeReadPrivateCodeData(HOBJECT hObj, BYTE* pBuffer, int nBufSize);
CP5200API int		CALLING_CONV CP5200_ParseReadPrivateCodeRet(HOBJECT hObj, const BYTE* pBuffer, int nLength, BYTE* pInfoBuffer, int nInfoBufSize);

//===============================================
//20160914
CP5200API int		CALLING_CONV CP5200_MakeWriteIDBaudrateData(HOBJECT hObj, BYTE* pBuffer, int nBufSize, byte byID , byte byBaudIndex );
CP5200API int		CALLING_CONV CP5200_ParseWriteIDBaudrateRet(HOBJECT hObj, const BYTE* pBuffer, int nLength); 

CP5200API int		CALLING_CONV CP5200_MakeReadIDBaudrateData(HOBJECT hObj, BYTE* pBuffer, int nBufSize );
CP5200API int		CALLING_CONV CP5200_ParseReadIDBaudrateRet(HOBJECT hObj, const BYTE* pBuffer, int nLength , BYTE* pInfoBuffer, int nInfoBufSize ); 
...
CP5200API int		CALLING_CONV CPowerBox_MakeSendMultiItemData(HOBJECT hObj, const BYTE *pText, int nLength );
CP5200API int		CALLING_CONV CPowerBox_ParseSendMultiItemRet(HOBJECT hObj, const BYTE* pBuffer, int nLength);
...
CP5200API int		CALLING_CONV CP5200_RS232_WritePrivateCode(int nCardID, const BYTE *pCodeData, int nLength);
CP5200API int		CALLING_CONV CP5200_RS232_ReadPrivateCode(int nCardID, BYTE *pCodeBuf, int nBufSize);
CP5200API int		CALLING_CONV CP5200_RS232_ReadIDBaudrate(BYTE nCardID, BYTE *pBuf, int nBufSize );
CP5200API int		CALLING_CONV CP5200_RS232_WriteIDBaudrate(BYTE nCardID,BYTE byID , BYTE byBaudIndex );
...
CP5200API int		CALLING_CONV CPowerBox_RS232_SendMultiItem(int nCardID, const BYTE *pText, int nLength);
...
CP5200API int		CALLING_CONV CP5200_Net_WritePrivateCode(int nCardID, const BYTE *pCodeData, int nLength);
CP5200API int		CALLING_CONV CP5200_Net_ReadPrivateCode(int nCardID, BYTE *pCodeBuf, int nBufSize);
CP5200API int		CALLING_CONV CP5200_Net_ReadIDBaudrate(BYTE nCardID, BYTE *pBuf, int nBufSize );
CP5200API int		CALLING_CONV CP5200_Net_WriteIDBaudrate(BYTE nCardID,BYTE byID , BYTE byBaudIndex );
...
CP5200API int		CALLING_CONV CPowerBox_Net_SendMultiItem(int nCardID, const BYTE *pText, int nLength);
