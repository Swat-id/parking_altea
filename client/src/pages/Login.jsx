...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    console.log('Login: handleSubmit ejecutado - FORMULARIO ENVIADO')
    console.log('Login: Valores del formulario:', { email, password })
    setLoading(true)
    setError('')
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button
              type="submit"
              disabled={loading}
              onClick={() => console.log('Login: Botón clickeado')}
